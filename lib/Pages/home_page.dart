...
import 'package:my_app/Pages/trainings_list.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  _initData() async {
    ...
    trainings = await json.decode(data);
  }
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          padding:
              EdgeInsets.only(top: statusBarHeight + 30, left: 30, right: 30),
          child: Column(
            children: [
                    ...
                    child: Row(
                      children: [
                        Text(
                          "Details",
                          style: TextStyle(
                              fontSize: 17, color: AppColors.homePageDetail),
                        ),
                        const SizedBox(
                          width: 5,
                        ),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    image:
                                        AssetImage(trainings[secondId]['img']),
                                    scale: 10,
                                  ),
                                  boxShadow: [
                                    BoxShadow(
